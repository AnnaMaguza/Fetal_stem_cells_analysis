...
metrics_df.to_csv(f'Repos/Fetal_stem_cells_analysis/7_endothelial_cell_states_annotation/figures/benchmark_metrics_endothelial_sample_id_{timestamp}.csv')

# Create and save plot
fig = plt.figure(figsize=(10, 6))
bm.plot_results_table(min_max_scale=False)
plt.savefig(f'Repos/Fetal_stem_cells_analysis/7_endothelial_cell_states_annotation/figures/benchmark_metrics_endothelial_sample_id_{timestamp}.png', dpi=300, bbox_inches='tight')
plt.close()